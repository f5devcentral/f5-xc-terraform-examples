Deploying F5 XC WAF on AWS Customer Edge 
=============================
...
Overview
#########
This demo guide step-by-step walkthrough on the deployment of Customer Edge with WAF enabled on AWS Platform. For more information on different WAAP deployment modes, refer to the devcentral article: `Deploy WAAP Anywhere with F5 Distributed Cloud <https://community.f5.com/t5/technical-articles/deploy-waf-anywhere-with-f5-distributed-cloud/ta-p/313079>`__.
