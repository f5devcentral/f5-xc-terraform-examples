...
6. As the origin server is the worker node of the EKS cluster, Productpage pod will then internally call the details microservice and the request will be sent to the egress interface gateway of the AWS CE site.
