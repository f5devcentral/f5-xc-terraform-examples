...
* **F5 Distributed Cloud WAF** 
  ...
  | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
  | [Deploy WAF Anywhere with F5 Distributed Cloud](https://community.f5.com/t5/technical-articles/deploy-waf-anywhere-with-f5-distributed-cloud/ta-p/313079)           | [**Coming soon:** Deploy F5 XC WAF on XC Regional Edges](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/blob/main/workflow-guides/waf/f5-xc-waf-on-re/README.rst)                                         |
  | [Deploy WAF Anywhere with F5 Distributed Cloud](https://community.f5.com/t5/technical-articles/deploy-waf-anywhere-with-f5-distributed-cloud/ta-p/313079) | [**Coming soon:** Deploy F5 XC WAF on XC Regional Edges + AppConnect](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/blob/main/workflow-guides/waf/f5-xc-waf-on-re-appconnect/README.rst) |
  | [Deploy WAF Anywhere with F5 Distributed Cloud](https://community.f5.com/t5/technical-articles/deploy-waf-anywhere-with-f5-distributed-cloud/ta-p/313079) | [Demo guide to deploy F5 XC WAF on XC Customer Edges](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/blob/main/workflow-guides/waf/f5-xc-waf-on-ce/README.rst)                        |
  | [Deploy WAF Anywhere with F5 Distributed Cloud](https://community.f5.com/t5/technical-articles/deploy-waf-anywhere-with-f5-distributed-cloud/ta-p/313079) | [**Coming soon:** Deploy F5 XC WAF on XC Customer Edges + MultiCloud](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/blob/main/workflow-guides/waf/f5-xc-waf-on-ce-multicloud/README.rst) |
  | [Deploying F5 Distributed Cloud WAAP on Kubernetes](https://community.f5.com/t5/technical-articles/deploying-f5-distributed-cloud-waap-on-kubernetes/ta-p/317324) | [Demo guide to deploy F5 XC WAF on Kubernetes](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/blob/main/workflow-guides/waf/f5-xc-waf-on-k8s/README.rst)                               |
...
* **F5 Distributed Cloud Bot Protection**
  | **DevCentral Overview Articles**                                                                                                                                                       | **Use Case / Workflow Guides (SaaS Console, Automation)**                                                                                                                                                        |
  | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
  | [**Coming soon:** Deploy Bot Defense against Automated Threats on Regional Edges with F5 Distributed Cloud](https://community.f5.com/t5/technical-articles/deploy-bot-defense-as-code-iac-or-saas-console-on-regional-edges/ta-p/320270) | [**Coming soon:** Deploy Bot Defense against Automated Threats on Regional Edges with F5 XC](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/blob/main/workflow-guides/bot/Deploy%20Bot%20Defense%20against%20Automated%20Threats%20on%20Regional%20Edges%20with%20F5%20XC/README.rst)                         |
  | [**Coming soon:**  Deploy Bot Defense for AWS Cloudfront with F5 Distributed Cloud](https://community.f5.com/t5/technical-articles/deploy-bot-defense-as-code-iac-or-saas-console-for-aws/ta-p/321663)   | [**Coming soon:** Deploy F5 XC Bot Defense for AWS Cloudfront with F5 Distributed Cloud](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/tree/main/workflow-guides/bot/Deploy%20Bot%20Defense%20for%20AWS%20Cloudfront%20Distributions%20with%20F5%20Distributed%20Cloud) |
  | [**Coming soon:**  Deploy Bot Defense for On-prem Applications Using BIG-IP Connector with F5 Distributed Cloud](https://community.f5.com/t5/technical-articles/deploy-bot-defense-as-code-iac-or-saas-console-for-on-prem-apps/ta-p/321665)   | [**Coming soon:** Deploy Bot Defense for On-prem Applications Using BIG-IP Connector for F5 Distributed Cloud](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/tree/main/workflow-guides/bot/Deploy%20Bot%20Defense%20for%20On-prem%20Applications%20with%20F5%20Distributed%20Cloud%20BIG-IP%20Connector)                         |
  | [**Coming soon:**  Deploy Bot Defense to Protect GCP Applications with F5 Distributed Cloud](https://community.f5.com/t5/technical-articles/deploy-bot-defense-as-code-iac-or-saas-console-for-gcp/ta-p/321667)   | [**Coming soon:** Deploy Bot Defense to Protect GCP Applications with F5 Distributed Cloud](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/tree/main/workflow-guides/bot/Deploy%20F5%20XC%20Bot%20Defense%20to%20Protect%20GCP%20Applications) |
