...
* **F5 Distributed Cloud WAF**
  ...
  | [ Deploy WAAP on Kubernetes](https://community.f5.com/t5/technical-articles/deploy-waap-anywhere-with-f5-distributed-cloud/ta-p/313079) | [Demo guide to Deploy F5 XC WAAP on Kubernetes](https://github.com/janibashamd/f5-xc-waap-terraform-examples/blob/waap-on-k8s/workflow-guides/waf/f5-xc-waf-on-k8s/README.md)                               |
