...
* **F5 Distributed Cloud Bot Protection**
  | **DevCentral Overview Articles**                                                                                                                                                       | **Use Case / Workflow Guides (SaaS Console, Automation)**                                                                                                                                                        |
  | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
  | [**Coming soon:** Deploy Bot Defense against Automated Threats on Regional Edges with F5 XC ](https://community.f5.com/t5/technical-articles/deploy-bot-defense-against-automated-threats-on-regional-edges/ta-p/320270
) | [**Coming soon:** Deploy Bot Defense against Automated Threats on Regional Edges with F5 XC](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/blob/main/workflow-guides/bot/Deploy%20Bot%20Defense%20against%20Automated%20Threats%20on%20Regional%20Edges%20with%20F5%20XC/README.rst))                         |
