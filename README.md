...
Check this [Deploy F5 Distributed Cloud WAAP anywhere DevCentral Overview article](https://community.f5.com/t5/technical-articles/deploy-waap-anywhere-with-f5-distributed-cloud/ta-p/313079) for more details. <br>
...
* **F5 Distributed Cloud WAF** 
  ...
  | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
  | [**Coming soon:**  Deploy WAF Anywhere with F5 Distributed Cloud]()           | [**Coming soon:** Deploy F5 XC WAF on XC Regional Edges](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/blob/main/workflow-guides/waf/f5-xc-waf-on-re/README.rst)                                         |
  | [**Coming soon:**  Deploy WAF Anywhere with F5 Distributed Cloud]() | [**Coming soon:** Deploy F5 XC WAF on XC Regional Edges + AppConnect](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/blob/main/workflow-guides/waf/f5-xc-waf-on-re-appconnect/README.rst) |
  | [**Coming soon:**  Deploy WAF Anywhere with F5 Distributed Cloud]() | [**Coming soon:** Deploy F5 XC WAF on XC Customer Edges](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/blob/main/workflow-guides/waf/f5-xc-waf-on-ce/README.rst)                        |
  | [**Coming soon:**  Deploy WAF Anywhere with F5 Distributed Cloud]() | [**Coming soon:** Deploy F5 XC WAF on XC Customer Edges + MultiCloud](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/blob/main/workflow-guides/waf/f5-xc-waf-on-ce-multicloud/README.rst) |
  | [**Coming soon:**  Deploy WAF Anywhere with F5 Distributed Cloud]() | [Demo guide to Deploy F5 XC WAF on Kubernetes](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/blob/main/workflow-guides/waf/f5-xc-waf-on-k8s/README.md)                               |
...
| [Deploy API Security Anywhere with F5 Distributed Cloud](https://community.f5.com/t5/technical-articles/deploy-waap-anywhere-with-f5-distributed-cloud/ta-p/313079)   | [Demo guide to Deploy F5 XC WAF on Kubernetes](workflow-guides/waf/f5-xc-waf-on-k8s/README.md)                               |
...
* **F5 Distributed Cloud Bot Protection**
  ...
  | [**Coming soon:**  Deploy Bot Defense for Hybrid Edge and AWS Cloudfront Distributions with F5 Distributed Cloud](https://community.f5.com/t5/technical-articles/deploy-waap-anywhere-with-f5-distributed-cloud/ta-p/313079)   | [**Coming soon:** Deploy F5 XC Bot Defense on XC Regional Edges + AppConnect](https://github.com/f5devcentral/f5-xc-waap-terraform-examples/blob/main/workflow-guides/waf/f5-xc-waf-on-re-appconnect/README.rst) |
