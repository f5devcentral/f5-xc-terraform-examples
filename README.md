...
## **F5 Distributed Cloud Application Delivery and Security**
  ...
  | [F5 XC Application Delivery and Security for Application Migration across Heterogeneous Environments](https://community.f5.com/kb/technicalarticles/app-migration-across-heterogeneous-environments-using-f5-distributed-cloud/344192) | [F5 XC Application Delivery and Security for Application Migration across Heterogeneous Environments (SaaS Console)](https://github.com/f5devcentral/f5-xc-terraform-examples/blob/main/workflow-guides/application-delivery-security/migration/README.rst)                        |
